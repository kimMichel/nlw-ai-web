        ...
        <aside className='w-80 space-y-6'>
          ...
          <form className='space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <span className='block text-xs text-muted-foreground'>Voce poderá customizar essa opção em breve</span>
            </div>
            ...
            <div className='space-y-4'>
              ...
              <Slider
                ...
                step={0.1}
              />
              <span className='block text-xs text-muted-foreground leading-relaxed'>Valores mais altos tendem a deixar o resultado mais criativo e com possíveis erros</span>
            </div>
